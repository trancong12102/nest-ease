...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "apps/example/src/prisma-client",
    "example/src/prisma-client",
  ]
...
path.join(process.cwd(), "apps/example/src/prisma-client/libquery_engine-darwin.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "apps/example/src/prisma-client/schema.prisma")
